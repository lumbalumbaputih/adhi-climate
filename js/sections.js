...
(function () {
  ...
  function PStory({
    ...
    }, "Why it matters"), p.meaning), p.radar && window.AdhiCharts && window.AdhiCharts.DotCompare && /*#__PURE__*/React.createElement(Reveal, {
      className: "story__radar",
      delay: 120
    }, /*#__PURE__*/React.createElement("div", {
      className: "story__chart-title"
    }, "How the three compare, pillar by pillar"), React.createElement(window.AdhiCharts.DotCompare, {
      data: p.radar,
      label: "Dot plot comparing Rio Tinto, Woodside and BHP on the four AASB S2 pillars (governance, strategy, risk management, and metrics and targets), each scored out of 4."
    }), /*#__PURE__*/React.createElement("p", {
      className: "story__radar-note"
    }, "Each dot is one company's pillar score out of 4, and the grey bar is the spread between the three. Toggle a company in the legend, or hover a dot for the number. The gap is widest on metrics and targets, where Rio Tinto pulls a full point clear of BHP, while governance is the one pillar where Woodside edges ahead. But the catch this whole project turns on still applies: reporting well is not the same as being low-risk."), /*#__PURE__*/React.createElement("details", {
      className: "radar-alt"
    }, /*#__PURE__*/React.createElement("summary", null, "Prefer the radar view?"), React.createElement(window.AdhiCharts.RadarChart, {
      data: p.radar,
      label: "Radar chart of the same four pillar scores for Rio Tinto, Woodside and BHP."
    }), /*#__PURE__*/React.createElement("p", {
      className: "story__radar-note"
    }, "Same data as a shape: bigger and rounder means more complete disclosure. Radars flatter small differences on a four-axis diamond, which is why the dots above are the primary view."))), p.matrix && window.AASBMATRIX && window.AdhiCharts && window.AdhiCharts.ScoreHeat && /*#__PURE__*/React.createElement(Reveal, {
