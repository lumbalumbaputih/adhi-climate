...
(function () {
  ...
  function PChart({ vizKey, spec }) {
    ...
    const Comp = { line: AC.LineChart, bar: AC.BarChart, scatter: AC.ScatterChart, heat: AC.HeatTable, area: AC.AreaChart, calheat: AC.CalendarHeat, bubble: AC.BubbleTimeline }[spec.type];
